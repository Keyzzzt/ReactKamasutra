...
export const createField = (name, type, placeholder, component, validate, textContent = "", props={}) => {
    return (
        <div>
            <Field name={name} type={type} placeholder={placeholder} component={component} validate={validate} {...props}/>
        </div>
    )
}
